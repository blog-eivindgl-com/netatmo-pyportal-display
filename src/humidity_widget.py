...
class Humidity_Widget(displayio.Group):
    def __init__(self, cwd):
        ...
        # day weather
        self._day_sunny = cwd + "/icons/wi-day-sunny-60x60.bmp";
        self._day_sunny_overcast = cwd + "/icons/wi-day-sunny-overcast-60x60.bmp";
        self._day_cloudy = cwd + "/icons/wi-day-cloudy-60x60.bmp";
        self._day_sprinkle = cwd + "/icons/wi-day-sprinkle-60x60.bmp";
        self._day_showers = cwd + "/icons/wi-day-showers-60x60.bmp";
        self._day_rain = cwd + "/icons/wi-day-rain-60x60.bmp";
        self._day_sleet = cwd + "/icons/wi-day-sleet-60x60.bmp";
        self._day_snow = cwd + "/icons/wi-day-snow-60x60.bmp";

        # night weather

        self._weather_icon_sprite = None
        self._weather_icon_file = None
        self._weather_icon_group = displayio.Group(x=0, y=0, scale=4)
